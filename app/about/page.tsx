...
export default function AboutPage() {
  return (
    <div className="container mx-auto py-12">
      <h1 className="text-4xl font-bold text-center mb-8">About Mood Whisper</h1>
      <div className="max-w-3xl mx-auto mb-12">
        <p className="text-xl text-center text-muted-foreground mb-6">
          At Mood Whisper, we're on a mission to transform workplaces by harnessing the power of real-time employee engagement data.
        </p>
        <p className="text-lg text-center text-muted-foreground">
          Founded in 2020, we&apos;ve helped hundreds of companies improve their workplace culture, boost productivity, and retain top talent through our innovative platform.
        </p>
      </div>

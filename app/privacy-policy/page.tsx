    ...
    <div className="container mx-auto py-12">
      ...
      <Card className="max-w-3xl mx-auto">
        ...
        <CardContent className="prose dark:prose-invert max-w-none">
          ...
          <p>Mood Whisper (&ldquo;we&rdquo;, &ldquo;our&rdquo;, or &ldquo;us&rdquo;) is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our employee engagement platform.</p>

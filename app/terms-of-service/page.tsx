    ...
    <div className="container mx-auto py-12">
      ...
      <Card className="max-w-3xl mx-auto">
        ...
        <CardContent className="prose dark:prose-invert max-w-none">
          ...
          <p>
            By accessing or using the Mood Whisper platform, you agree to be
          ...
          <ul>
            ...
            <li>
              To impersonate or attempt to impersonate Mood Whisper, a Mood
              Whisper employee, another user, or any other person or entity
            </li>
          </ul>

          <h2>3. Intellectual Property</h2>
          <p>
            The Mood Whisper platform and its original content, features, and
            functionality are and will remain the exclusive property of Mood
            Whisper and its licensors. Our trademarks and trade dress may not be
            used in connection with any product or service without the prior
            written consent of Mood Whisper.
          </p>
          ...
          <p>
            In no event shall Mood Whisper, nor its directors, employees,

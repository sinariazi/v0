      ...
      <Card className="max-w-2xl mx-auto">
        ...
        <form onSubmit={handleSubmit}>
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="companyPhoneNumber">{t("forms.companyPhoneNumber")}</Label>
              <Input
            ...
            <div className="space-y-2">
              <Label htmlFor="companyIndustry">{t("forms.companyIndustry")}</Label>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => setCompanyCountry(e.target.value.toLowerCase())}
                required
              />
            </div>
            <div className="space-y-2">
          ...
          <CardFooter>
            <Button type="submit" className="w-full" disabled={isSubmitting}>
              {isSubmitting ? t("forms.creating") : t("startFreeTrial.buttonText")}
            </Button>
          </CardFooter>
        </form>
      </Card>
      ...
      <Dialog open={showConfirmation} onOpenChange={setShowConfirmation}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>{t("startFreeTrial.confirmationDescription", { organizationId })}</DialogDescription>
          </DialogHeader>
          <Button onClick={handleConfirmationClose}>{t("startFreeTrial.goToDashboard")}</Button>
        </DialogContent>
      </Dialog>
    </div>
  )

...
const industries = [
  ...
  "Hospitality", "Transportation", "Energy", "Real Estate", "Media", 
  "Telecommunications", "Consulting", "Non-profit", "Other"
]
      ...
      <Dialog open={showConfirmation} onOpenChange={setShowConfirmation}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Your organization account has been created with the ID: {organizationId}. 
              You have been assigned as an admin for this organization.
            </DialogDescription>
          </DialogHeader>
